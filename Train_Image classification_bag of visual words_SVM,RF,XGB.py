...
<script crossorigin="anonymous" defer="defer" type="application/javascript" src="https://github.githubassets.com/assets/react-code-view-0b89fcb43272.js"></script>
  ...
  <title>Classical-Machine-Learning/Train_Image classification_bag of visual words_SVM,RF,XGB.py at gouthamvasam-image-classification · gouthamvasam/Classical-Machine-Learning</title>
  ...
  <meta name="request-id" content="C6C9:521F:A74A10:F6688F:657B66C4" data-turbo-transient="true" /><meta name="html-safe-nonce" content="a7e04df7b7c55af9997bc5f8a01592d1f9f9b8a933f5a8e4ae3a2350cb95fdf6" data-turbo-transient="true" /><meta name="visitor-payload" content="" data-turbo-transient="true" /><meta name="visitor-hmac" content="f196a7081397a6febf8de7bcd66240fd02d9a9e496740aca19b00d1f615e6102" data-turbo-transient="true" />
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" /><meta name="octolytics-actor-id" content="98245058" /><meta name="octolytics-actor-login" content="gouthamvasam" /><meta name="octolytics-actor-hash" content="ed6fbe6720f76c5e69afd67fc8b791e6f7927fbea1fdb2756f87e617031c4024" />
  ...
  <link rel="sudo-modal" href="/sessions/sudo_modal">
    ...
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/gouthamvasam/Classical-Machine-Learning/blob/gouthamvasam-image-classification/Train_Image%20classification_bag%20of%20visual%20words_SVM%2CRF%2CXGB.py" />
      <meta name="twitter:image:src" content="https://opengraph.githubassets.com/b1c969db2f6cedc8cf2bb4a4badb14563120174f34f7e8337a33e258558581bc/gouthamvasam/Classical-Machine-Learning" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="Classical-Machine-Learning/Train_Image classification_bag of visual words_SVM,RF,XGB.py at gouthamvasam-image-classification · gouthamvasam/Classical-Machine-Learning" /><meta name="twitter:description" content="Contribute to gouthamvasam/Classical-Machine-Learning development by creating an account on GitHub." />
      <meta property="og:image" content="https://opengraph.githubassets.com/b1c969db2f6cedc8cf2bb4a4badb14563120174f34f7e8337a33e258558581bc/gouthamvasam/Classical-Machine-Learning" /><meta property="og:image:alt" content="Contribute to gouthamvasam/Classical-Machine-Learning development by creating an account on GitHub." /><meta property="og:image:width" content="1200" /><meta property="og:image:height" content="600" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="Classical-Machine-Learning/Train_Image classification_bag of visual words_SVM,RF,XGB.py at gouthamvasam-image-classification · gouthamvasam/Classical-Machine-Learning" /><meta property="og:url" content="https://github.com/gouthamvasam/Classical-Machine-Learning/blob/gouthamvasam-image-classification/Train_Image%20classification_bag%20of%20visual%20words_SVM%2CRF%2CXGB.py" /><meta property="og:description" content="Contribute to gouthamvasam/Classical-Machine-Learning development by creating an account on GitHub." />
      

      <link rel="shared-web-socket" href="wss://alive.github.com/_sockets/u/98245058/ws?session=eyJ2IjoiVjMiLCJ1Ijo5ODI0NTA1OCwicyI6MTI2ODgxNjYzMSwiYyI6MTA5NzU1OTAxNiwidCI6MTcwMjU4NjA1OH0=--81999edf559b6212054efa1141b54b8c17a620ce6be142439ef1ea01e76faa11" data-refresh-url="/_alive" data-session-id="991dc5f8b19f43f1265dd0a8127c42a9d73be3c0c3ba3fb650db9404fd24414f">
...
<script crossorigin="anonymous" defer="defer" type="application/javascript" src="https://github.githubassets.com/assets/command-palette-4bc66cb6a700.js"></script>
  ...
  <include-fragment data-target="deferred-side-panel.fragment">
      <button aria-label="Open global navigation menu" data-action="click:deferred-side-panel#loadPanel click:deferred-side-panel#panelOpened" data-show-dialog-id="dialog-da156cc9-1f18-4e63-8e99-7c6f60fb4aab" id="dialog-show-dialog-da156cc9-1f18-4e63-8e99-7c6f60fb4aab" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-bg-transparent p-0 color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-three-bars Button-visual">
    <path d="M1 2.75A.75.75 0 0 1 1.75 2h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 2.75Zm0 5A.75.75 0 0 1 1.75 7h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 7.75ZM1.75 12h12.5a.75.75 0 0 1 0 1.5H1.75a.75.75 0 0 1 0-1.5Z"></path>
</svg>
</button>

<div class="Overlay--hidden Overlay-backdrop--side Overlay-backdrop--placement-left" data-modal-dialog-overlay>
  <modal-dialog data-target="deferred-side-panel.panel" role="dialog" id="dialog-da156cc9-1f18-4e63-8e99-7c6f60fb4aab" aria-modal="true" aria-disabled="true" aria-labelledby="dialog-da156cc9-1f18-4e63-8e99-7c6f60fb4aab-title" aria-describedby="dialog-da156cc9-1f18-4e63-8e99-7c6f60fb4aab-description" data-view-component="true" class="Overlay Overlay-whenNarrow Overlay--size-small-portrait Overlay--motion-scaleFade SidePanel">
    <div styles="flex-direction: row;" data-view-component="true" class="Overlay-header">
  <div class="Overlay-headerContentWrap">
    <div class="Overlay-titleWrap">
      <h1 class="Overlay-title sr-only" id="dialog-da156cc9-1f18-4e63-8e99-7c6f60fb4aab-title">
        Global navigation
      </h1>
    ...
    <div class="Overlay-actionWrap">
      <button data-close-dialog-id="dialog-da156cc9-1f18-4e63-8e99-7c6f60fb4aab" aria-label="Close" type="button" data-view-component="true" class="close-button Overlay-closeButton"><svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x">
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g d" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;HOME&quot;,&quot;label&quot;:null}" id="item-bcb07dea-20b6-4cc7-a815-d77225db36a9" href="/dashboard" data-view-component="true" class="ActionListContent ActionListContent--visual16">
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g i" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES&quot;,&quot;label&quot;:null}" id="item-c17befa8-973d-4742-8582-ef02ade22a0b" href="/issues" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g p" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS&quot;,&quot;label&quot;:null}" id="item-beac18c3-eee6-4b30-8401-9031e16e023e" href="/pulls" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-item-id="projects" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PROJECTS&quot;,&quot;label&quot;:null}" id="item-043707c4-9e2d-4c2b-8913-39fc670a0e07" href="/projects" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;DISCUSSIONS&quot;,&quot;label&quot;:null}" id="item-a17e2912-6002-4c97-8729-2531c0bb3b0f" href="/discussions" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;CODESPACES&quot;,&quot;label&quot;:null}" id="item-907d152c-ae18-4ae0-a5a8-8836d7798813" href="https://github.com/codespaces" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;EXPLORE&quot;,&quot;label&quot;:null}" id="item-c52f5e71-1518-4447-b395-38ed202e4597" href="/explore" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;MARKETPLACE&quot;,&quot;label&quot;:null}" id="item-140b21a9-255c-4b9e-bdad-9d95b0463fe6" href="/marketplace" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<qbsearch-input class="search-input" data-scope="repo:gouthamvasam/Classical-Machine-Learning" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="NarLI4Un9VDY-RqQ3W6KeW-Js9S0Z8NQ77xBeWkgPpJ9N-1aJeDA4e-OM5BXYsNOMoCFwve-0WFo7AdNgtLedg" data-max-custom-scopes="10" data-header-redesign-enabled="true" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="gouthamvasam/Classical-Machine-Learning" data-current-org="" data-current-owner="gouthamvasam" data-logged-in="true" data-copilot-chat-enabled="false" data-blackbird-indexed-repo-csrf="<input type=&quot;hidden&quot; value=&quot;tgMFVIxncjTHM3wJjhKSqqCJsdrM-WPOAfqYQE6j_W61FjiF_YbyfbSQkJdutv42_JUNytFBRcLJw8v2Pmd_Wg&quot; data-csrf=&quot;true&quot; />">
  <div
...
<div class="AppHeader-search-whenRegular">
  <div class="AppHeader-search-wrap AppHeader-search-wrap--hasTrailing">
    ...
    <path d="m6.354 8.04-4.773 4.773a.75.75 0 1 0 1.061 1.06L7.945 8.57a.75.75 0 0 0 0-1.06L2.642 2.206a.75.75 0 0 0-1.06 1.061L6.353 8.04ZM8.75 11.5a.75.75 0 0 0 0 1.5h5.5a.75.75 0 0 0 0-1.5h-5.5Z"></path>
      ...
      <tool-tip id="tooltip-46cbe367-a50e-4a49-8f3a-4ad2613a5a12" for="AppHeader-commandPalette-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Command palette</tool-tip>
  </div>
</div>
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-3443385e-36f1-49d1-983e-7ddb4e33342d" data-target="query-builder.input" data-action="
...
<template id="copilot-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-copilot">
    <path d="M7.998 15.035c-4.562 0-7.873-2.914-7.998-3.749V9.338c.085-.628.677-1.686 1.588-2.065.013-.07.024-.143.036-.218.029-.183.06-.384.126-.612-.201-.508-.254-1.084-.254-1.656 0-.87.128-1.769.693-2.484.579-.733 1.494-1.124 2.724-1.261 1.206-.134 2.262.034 2.944.765.05.053.096.108.139.165.044-.057.094-.112.143-.165.682-.731 1.738-.899 2.944-.765 1.23.137 2.145.528 2.724 1.261.566.715.693 1.614.693 2.484 0 .572-.053 1.148-.254 1.656.066.228.098.429.126.612.012.076.024.148.037.218.924.385 1.522 1.471 1.591 2.095v1.872c0 .766-3.351 3.795-8.002 3.795Zm0-1.485c2.28 0 4.584-1.11 5.002-1.433V7.862l-.023-.116c-.49.21-1.075.291-1.727.291-1.146 0-2.059-.327-2.71-.991A3.222 3.222 0 0 1 8 6.303a3.24 3.24 0 0 1-.544.743c-.65.664-1.563.991-2.71.991-.652 0-1.236-.081-1.727-.291l-.023.116v4.255c.419.323 2.722 1.433 5.002 1.433ZM6.762 2.83c-.193-.206-.637-.413-1.682-.297-1.019.113-1.479.404-1.713.7-.247.312-.369.789-.369 1.554 0 .793.129 1.171.308 1.371.162.181.519.379 1.442.379.853 0 1.339-.235 1.638-.54.315-.322.527-.827.617-1.553.117-.935-.037-1.395-.241-1.614Zm4.155-.297c-1.044-.116-1.488.091-1.681.297-.204.219-.359.679-.242 1.614.091.726.303 1.231.618 1.553.299.305.784.54 1.638.54.922 0 1.28-.198 1.442-.379.179-.2.308-.578.308-1.371 0-.765-.123-1.242-.37-1.554-.233-.296-.693-.587-1.713-.7Z"></path><path d="M6.25 9.037a.75.75 0 0 1 .75.75v1.501a.75.75 0 0 1-1.5 0V9.787a.75.75 0 0 1 .75-.75Zm4.25.75v1.501a.75.75 0 0 1-1.5 0V9.787a.75.75 0 0 1 1.5 0Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-3443385e-36f1-49d1-983e-7ddb4e33342d" hidden="hidden">
...
<div class="Overlay--hidden Overlay-backdrop--center" data-modal-dialog-overlay>
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="EQPmVqAvSjRWvJfvKhK4QiOESONRREzMGrScCCNYwaeoYpN-jGDJs57hLQWOoBRgUMTSkcng6GkM5BxYwbyycg" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <div data-view-component="true" class="Overlay-body">        <div data-target="custom-scopes.customScopesModalDialogFlash"></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="8MlPKAWEadHfJD3_hRMwsXpPHJx7pLtsKtl9dpi5FD4ha-Z_sE2Qx37-5vtmcfXBo-nJz7PSdTumANVOzn-LPA" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" value="kNqU0Kk17YybofCYX_J1tVndnqvTFa8MXjy30bOaZugg4pmT6Yyh41XFNyUH7YYnQSLrlVoUP-Is-oJkUXO4TQ" data-csrf="true" />
            </auto-check>
          </div>
...
</qbsearch-input><input type="hidden" value="m39ux3jvayQavjta2d4qi4Tomag-C6g_F3erEZV_cyUjYdTaM_PIU1Iv-oY8QFna7YRuHKn5NNtq63GUgGY5Uw" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" />
...
</button><tool-tip id="tooltip-34cc96d7-8646-4d78-88d4-3f4f6df2b919" for="global-create-menu-button" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">Create new...</tool-tip>
...
<anchored-position id="global-create-menu-overlay" anchor="global-create-menu-button" align="end" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  ...
  <ul aria-labelledby="global-create-menu-button" id="global-create-menu-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
    ...
    <a href="/new" tabindex="-1" id="item-5826061f-c692-4440-a1b5-9923aaf8d5f4" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo">
    <path d="M2 2.5A2.5 2.5 0 0 1 4.5 0h8.75a.75.75 0 0 1 .75.75v12.5a.75.75 0 0 1-.75.75h-2.5a.75.75 0 0 1 0-1.5h1.75v-2h-8a1 1 0 0 0-.714 1.7.75.75 0 1 1-1.072 1.05A2.495 2.495 0 0 1 2 11.5Zm10.5-1h-8a1 1 0 0 0-1 1v6.708A2.486 2.486 0 0 1 4.5 9h8ZM5 12.25a.25.25 0 0 1 .25-.25h3.5a.25.25 0 0 1 .25.25v3.25a.25.25 0 0 1-.4.2l-1.45-1.087a.249.249 0 0 0-.3 0L5.4 15.7a.25.25 0 0 1-.4-.2Z"></path>
</svg>
    ...
    <a href="/new/import" tabindex="-1" id="item-a462025f-5a19-47e4-920d-a046515c664e" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a href="/codespaces/new" tabindex="-1" id="item-83ef7a81-6f56-465d-b4da-5b6b1c698383" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-codespaces">
    <path d="M0 11.25c0-.966.784-1.75 1.75-1.75h12.5c.966 0 1.75.784 1.75 1.75v3A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25Zm2-9.5C2 .784 2.784 0 3.75 0h8.5C13.216 0 14 .784 14 1.75v5a1.75 1.75 0 0 1-1.75 1.75h-8.5A1.75 1.75 0 0 1 2 6.75Zm1.75-.25a.25.25 0 0 0-.25.25v5c0 .138.112.25.25.25h8.5a.25.25 0 0 0 .25-.25v-5a.25.25 0 0 0-.25-.25Zm-2 9.5a.25.25 0 0 0-.25.25v3c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-3a.25.25 0 0 0-.25-.25Z"></path><path d="M7 12.75a.75.75 0 0 1 .75-.75h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1-.75-.75Zm-4 0a.75.75 0 0 1 .75-.75h.5a.75.75 0 0 1 0 1.5h-.5a.75.75 0 0 1-.75-.75Z"></path>
</svg>
    ...
    <a href="https://gist.github.com/" tabindex="-1" id="item-7d960d97-af3a-4000-824f-a9d923b7790d" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-code">
    <path d="m11.28 3.22 4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.275-.326.749.749 0 0 1 .215-.734L13.94 8l-3.72-3.72a.749.749 0 0 1 .326-1.275.749.749 0 0 1 .734.215Zm-6.56 0a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042L2.06 8l3.72 3.72a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L.47 8.53a.75.75 0 0 1 0-1.06Z"></path>
</svg>
    ...
    <a href="/account/organizations/new" tabindex="-1" data-dont-follow-via-test="true" data-analytics-event="{&quot;category&quot;:&quot;SiteHeaderComponent&quot;,&quot;action&quot;:&quot;add_dropdown&quot;,&quot;label&quot;:&quot;new organization&quot;}" id="item-ad759e31-078d-4da7-9549-5217a6fb9a17" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <path d="M1.75 16A1.75 1.75 0 0 1 0 14.25V1.75C0 .784.784 0 1.75 0h8.5C11.216 0 12 .784 12 1.75v12.5c0 .085-.006.168-.018.25h2.268a.25.25 0 0 0 .25-.25V8.285a.25.25 0 0 0-.111-.208l-1.055-.703a.749.749 0 1 1 .832-1.248l1.055.703c.487.325.779.871.779 1.456v5.965A1.75 1.75 0 0 1 14.25 16h-3.5a.766.766 0 0 1-.197-.026c-.099.017-.2.026-.303.026h-3a.75.75 0 0 1-.75-.75V14h-1v1.25a.75.75 0 0 1-.75.75Zm-.25-1.75c0 .138.112.25.25.25H4v-1.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 .75.75v1.25h2.25a.25.25 0 0 0 .25-.25V1.75a.25.25 0 0 0-.25-.25h-8.5a.25.25 0 0 0-.25.25ZM3.75 6h.5a.75.75 0 0 1 0 1.5h-.5a.75.75 0 0 1 0-1.5ZM3 3.75A.75.75 0 0 1 3.75 3h.5a.75.75 0 0 1 0 1.5h-.5A.75.75 0 0 1 3 3.75Zm4 3A.75.75 0 0 1 7.75 6h.5a.75.75 0 0 1 0 1.5h-.5A.75.75 0 0 1 7 6.75ZM7.75 3h.5a.75.75 0 0 1 0 1.5h-.5a.75.75 0 0 1 0-1.5ZM3 9.75A.75.75 0 0 1 3.75 9h.5a.75.75 0 0 1 0 1.5h-.5A.75.75 0 0 1 3 9.75ZM7.75 9h.5a.75.75 0 0 1 0 1.5h-.5a.75.75 0 0 1 0-1.5Z"></path>
        ...
        <span data-view-component="true" class="ActionListItem-label">
          ...
          <a href="/issues" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-0d21be08-eb3d-4b09-a055-4302f6f6ba69" aria-labelledby="tooltip-845817c4-241c-4a9a-a43c-97fbe77afe48" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened Button-visual">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
</a><tool-tip id="tooltip-845817c4-241c-4a9a-a43c-97fbe77afe48" for="icon-button-0d21be08-eb3d-4b09-a055-4302f6f6ba69" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Issues</tool-tip>

          <a href="/pulls" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-856ea847-63e0-4c7e-b919-5eae62946faa" aria-labelledby="tooltip-7f90f558-4dac-4409-8e7b-7f49db81e3b5" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request Button-visual">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
</a><tool-tip id="tooltip-7f90f558-4dac-4409-8e7b-7f49db81e3b5" for="icon-button-856ea847-63e0-4c7e-b919-5eae62946faa" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Pull requests</tool-tip>

        </div>

        
<notification-indicator data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6OTgyNDUwNTgiLCJ0IjoxNzAyNTg2MDU4fQ==--13adaea0dc994e55d49722c682d08b7d4d1651c5a90b477bf6ad3eb19fcb450f" data-indicator-mode="none" data-tooltip-global="You have unread notifications" data-tooltip-unavailable="Notifications are unavailable at the moment." data-tooltip-none="You have no unread notifications" data-header-redesign-enabled="true" data-fetch-indicator-src="/notifications/indicator" data-fetch-indicator-enabled="true" data-view-component="true" class="js-socket-channel">
    ...
    <tool-tip data-target="notification-indicator.tooltip" id="tooltip-16dcc2bb-7761-42c0-a32a-b811d9f486fd" for="AppHeader-notifications-button" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">Notifications</tool-tip>
  ...
  <include-fragment data-target="deferred-side-panel.fragment">
    ...
    <button aria-label="Open user account menu" data-action="click:deferred-side-panel#loadPanel click:deferred-side-panel#panelOpened" data-show-dialog-id="dialog-1c837695-030c-4dcf-aa09-4cc853d99be1" id="dialog-show-dialog-1c837695-030c-4dcf-aa09-4cc853d99be1" type="button" data-view-component="true" class="AppHeader-logo Button--invisible Button--medium Button Button--invisible-noVisuals color-bg-transparent p-0">  <span class="Button-content">
...
<div class="Overlay--hidden Overlay-backdrop--side Overlay-backdrop--placement-right" data-modal-dialog-overlay>
  <modal-dialog data-target="deferred-side-panel.panel" role="dialog" id="dialog-1c837695-030c-4dcf-aa09-4cc853d99be1" aria-modal="true" aria-disabled="true" aria-labelledby="dialog-1c837695-030c-4dcf-aa09-4cc853d99be1-title" aria-describedby="dialog-1c837695-030c-4dcf-aa09-4cc853d99be1-description" data-view-component="true" class="Overlay Overlay-whenNarrow Overlay--size-small-portrait Overlay--motion-scaleFade SidePanel">
    <div styles="flex-direction: row;" data-view-component="true" class="Overlay-header">
  <div class="Overlay-headerContentWrap">
    <div class="Overlay-titleWrap">
      <h1 class="Overlay-title sr-only" id="dialog-1c837695-030c-4dcf-aa09-4cc853d99be1-title">
        Account menu
      </h1>
            <div data-view-component="true" class="d-flex">
      <div data-view-component="true" class="AppHeader-logo position-relative">
...
</button><tool-tip id="tooltip-abbf4ce8-e3bd-4251-86a5-a69c6d882175" for="user-create-menu-button" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">Create new...</tool-tip>
...
<anchored-position id="user-create-menu-overlay" anchor="user-create-menu-button" align="end" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  ...
  <ul aria-labelledby="user-create-menu-button" id="user-create-menu-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
    ...
    <a href="/new" tabindex="-1" id="item-427496f6-c6e9-4cf5-bb25-7d15076580ae" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo">
    <path d="M2 2.5A2.5 2.5 0 0 1 4.5 0h8.75a.75.75 0 0 1 .75.75v12.5a.75.75 0 0 1-.75.75h-2.5a.75.75 0 0 1 0-1.5h1.75v-2h-8a1 1 0 0 0-.714 1.7.75.75 0 1 1-1.072 1.05A2.495 2.495 0 0 1 2 11.5Zm10.5-1h-8a1 1 0 0 0-1 1v6.708A2.486 2.486 0 0 1 4.5 9h8ZM5 12.25a.25.25 0 0 1 .25-.25h3.5a.25.25 0 0 1 .25.25v3.25a.25.25 0 0 1-.4.2l-1.45-1.087a.249.249 0 0 0-.3 0L5.4 15.7a.25.25 0 0 1-.4-.2Z"></path>
</svg>
    ...
    <a href="/new/import" tabindex="-1" id="item-20da97d8-c41d-4b3d-a2a9-63d8a3ddc398" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo-push">
    <path d="M1 2.5A2.5 2.5 0 0 1 3.5 0h8.75a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-1.5 0V1.5h-8a1 1 0 0 0-1 1v6.708A2.493 2.493 0 0 1 3.5 9h3.25a.75.75 0 0 1 0 1.5H3.5a1 1 0 0 0 0 2h5.75a.75.75 0 0 1 0 1.5H3.5A2.5 2.5 0 0 1 1 11.5Zm13.23 7.79h-.001l-1.224-1.224v6.184a.75.75 0 0 1-1.5 0V9.066L10.28 10.29a.75.75 0 0 1-1.06-1.061l2.505-2.504a.75.75 0 0 1 1.06 0L15.29 9.23a.751.751 0 0 1-.018 1.042.751.751 0 0 1-1.042.018Z"></path>
</svg>
    ...
    <a href="/codespaces/new" tabindex="-1" id="item-b966cecc-855a-45b1-b4ae-8c823279a45c" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-codespaces">
    <path d="M0 11.25c0-.966.784-1.75 1.75-1.75h12.5c.966 0 1.75.784 1.75 1.75v3A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25Zm2-9.5C2 .784 2.784 0 3.75 0h8.5C13.216 0 14 .784 14 1.75v5a1.75 1.75 0 0 1-1.75 1.75h-8.5A1.75 1.75 0 0 1 2 6.75Zm1.75-.25a.25.25 0 0 0-.25.25v5c0 .138.112.25.25.25h8.5a.25.25 0 0 0 .25-.25v-5a.25.25 0 0 0-.25-.25Zm-2 9.5a.25.25 0 0 0-.25.25v3c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-3a.25.25 0 0 0-.25-.25Z"></path><path d="M7 12.75a.75.75 0 0 1 .75-.75h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1-.75-.75Zm-4 0a.75.75 0 0 1 .75-.75h.5a.75.75 0 0 1 0 1.5h-.5a.75.75 0 0 1-.75-.75Z"></path>
</svg>
    ...
    <a href="https://gist.github.com/" tabindex="-1" id="item-483bdca7-37a2-4397-b8aa-d94ea9adfe14" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-code">
    <path d="m11.28 3.22 4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.275-.326.749.749 0 0 1 .215-.734L13.94 8l-3.72-3.72a.749.749 0 0 1 .326-1.275.749.749 0 0 1 .734.215Zm-6.56 0a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042L2.06 8l3.72 3.72a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L.47 8.53a.75.75 0 0 1 0-1.06Z"></path>
</svg>
    ...
    <a href="/account/organizations/new" tabindex="-1" data-dont-follow-via-test="true" data-analytics-event="{&quot;category&quot;:&quot;SiteHeaderComponent&quot;,&quot;action&quot;:&quot;add_dropdown&quot;,&quot;label&quot;:&quot;new organization&quot;}" id="item-2cdd0050-46c3-42ce-9db7-d1c354ad3005" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-organization">
    <path d="M1.75 16A1.75 1.75 0 0 1 0 14.25V1.75C0 .784.784 0 1.75 0h8.5C11.216 0 12 .784 12 1.75v12.5c0 .085-.006.168-.018.25h2.268a.25.25 0 0 0 .25-.25V8.285a.25.25 0 0 0-.111-.208l-1.055-.703a.749.749 0 1 1 .832-1.248l1.055.703c.487.325.779.871.779 1.456v5.965A1.75 1.75 0 0 1 14.25 16h-3.5a.766.766 0 0 1-.197-.026c-.099.017-.2.026-.303.026h-3a.75.75 0 0 1-.75-.75V14h-1v1.25a.75.75 0 0 1-.75.75Zm-.25-1.75c0 .138.112.25.25.25H4v-1.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 .75.75v1.25h2.25a.25.25 0 0 0 .25-.25V1.75a.25.25 0 0 0-.25-.25h-8.5a.25.25 0 0 0-.25.25ZM3.75 6h.5a.75.75 0 0 1 0 1.5h-.5a.75.75 0 0 1 0-1.5ZM3 3.75A.75.75 0 0 1 3.75 3h.5a.75.75 0 0 1 0 1.5h-.5A.75.75 0 0 1 3 3.75Zm4 3A.75.75 0 0 1 7.75 6h.5a.75.75 0 0 1 0 1.5h-.5A.75.75 0 0 1 7 6.75ZM7.75 3h.5a.75.75 0 0 1 0 1.5h-.5a.75.75 0 0 1 0-1.5ZM3 9.75A.75.75 0 0 1 3.75 9h.5a.75.75 0 0 1 0 1.5h-.5A.75.75 0 0 1 3 9.75ZM7.75 9h.5a.75.75 0 0 1 0 1.5h-.5a.75.75 0 0 1 0-1.5Z"></path>
</svg>
    ...
    <div class="Overlay-actionWrap">
      <button data-close-dialog-id="dialog-1c837695-030c-4dcf-aa09-4cc853d99be1" aria-label="Close" type="button" data-view-component="true" class="close-button Overlay-closeButton"><svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg></button>
    </div>
  </div>
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-2dd477f2-f04c-4dba-a470-f70f8deb22e5" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PROFILE&quot;,&quot;label&quot;:null}" id="item-dd3d507d-5b0c-4520-99af-1bccdd2c7343" href="https://github.com/gouthamvasam" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-9d7314ba-7a7c-4d15-968d-bc85e164a242" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <span data-view-component="true" class="d-flex flex-items-center">    <svg style="box-sizing: content-box; color: var(--color-icon-primary);" width="16" height="16" viewBox="0 0 16 16" fill="none" data-view-component="true" class="anim-rotate">
  <circle cx="8" cy="8" r="7" stroke="currentColor" stroke-opacity="0.25" stroke-width="2" vector-effect="non-scaling-stroke" fill="none" />
  <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" vector-effect="non-scaling-stroke" />
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;YOUR_REPOSITORIES&quot;,&quot;label&quot;:null}" id="item-5db05f3d-6c35-4857-82ca-a9c1d7950a92" href="/gouthamvasam?tab=repositories" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo">
    <path d="M2 2.5A2.5 2.5 0 0 1 4.5 0h8.75a.75.75 0 0 1 .75.75v12.5a.75.75 0 0 1-.75.75h-2.5a.75.75 0 0 1 0-1.5h1.75v-2h-8a1 1 0 0 0-.714 1.7.75.75 0 1 1-1.072 1.05A2.495 2.495 0 0 1 2 11.5Zm10.5-1h-8a1 1 0 0 0-1 1v6.708A2.486 2.486 0 0 1 4.5 9h8ZM5 12.25a.25.25 0 0 1 .25-.25h3.5a.25.25 0 0 1 .25.25v3.25a.25.25 0 0 1-.4.2l-1.45-1.087a.249.249 0 0 0-.3 0L5.4 15.7a.25.25 0 0 1-.4-.2Z"></path>
</svg>
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;YOUR_PROJECTS&quot;,&quot;label&quot;:null}" id="item-d5e83940-982a-4ede-95f3-803ab70798e1" href="/gouthamvasam?tab=projects" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-project">
    <path d="M1.75 0h12.5C15.216 0 16 .784 16 1.75v12.5A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25V1.75C0 .784.784 0 1.75 0ZM1.5 1.75v12.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25V1.75a.25.25 0 0 0-.25-.25H1.75a.25.25 0 0 0-.25.25ZM11.75 3a.75.75 0 0 1 .75.75v7.5a.75.75 0 0 1-1.5 0v-7.5a.75.75 0 0 1 .75-.75Zm-8.25.75a.75.75 0 0 1 1.5 0v5.5a.75.75 0 0 1-1.5 0ZM8 3a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-1.5 0v-3.5A.75.75 0 0 1 8 3Z"></path>
</svg>
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-71e80283-f985-49f7-87e7-f80a900ce320" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <span data-view-component="true" class="d-flex flex-items-center">    <svg style="box-sizing: content-box; color: var(--color-icon-primary);" width="16" height="16" viewBox="0 0 16 16" fill="none" data-view-component="true" class="anim-rotate">
  <circle cx="8" cy="8" r="7" stroke="currentColor" stroke-opacity="0.25" stroke-width="2" vector-effect="non-scaling-stroke" fill="none" />
  <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" vector-effect="non-scaling-stroke" />
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;YOUR_STARS&quot;,&quot;label&quot;:null}" id="item-94794e20-cd3b-463c-8ebd-0675b4a19b80" href="/gouthamvasam?tab=stars" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;SPONSORS&quot;,&quot;label&quot;:null}" id="item-6c84f844-924d-4f49-beab-a95bf3242b58" href="/sponsors/accounts" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;YOUR_GISTS&quot;,&quot;label&quot;:null}" id="item-d7b6d2eb-9c10-4d61-8edc-86cb4c256e7b" href="https://gist.github.com/mine" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-2c4f8233-4326-4695-900e-30fa89269d9c" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <span data-view-component="true" class="d-flex flex-items-center">    <svg style="box-sizing: content-box; color: var(--color-icon-primary);" width="16" height="16" viewBox="0 0 16 16" fill="none" data-view-component="true" class="anim-rotate">
  <circle cx="8" cy="8" r="7" stroke="currentColor" stroke-opacity="0.25" stroke-width="2" vector-effect="non-scaling-stroke" fill="none" />
  <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" vector-effect="non-scaling-stroke" />
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-d82dd7df-7b05-47ce-ab66-c51338ff9d80" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <span data-view-component="true" class="d-flex flex-items-center">    <svg style="box-sizing: content-box; color: var(--color-icon-primary);" width="16" height="16" viewBox="0 0 16 16" fill="none" data-view-component="true" class="anim-rotate">
  <circle cx="8" cy="8" r="7" stroke="currentColor" stroke-opacity="0.25" stroke-width="2" vector-effect="non-scaling-stroke" fill="none" />
  <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" vector-effect="non-scaling-stroke" />
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-1df6e26d-dda2-449c-8d44-5663e9e5779d" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <span data-view-component="true" class="d-flex flex-items-center">    <svg style="box-sizing: content-box; color: var(--color-icon-primary);" width="16" height="16" viewBox="0 0 16 16" fill="none" data-view-component="true" class="anim-rotate">
  <circle cx="8" cy="8" r="7" stroke="currentColor" stroke-opacity="0.25" stroke-width="2" vector-effect="non-scaling-stroke" fill="none" />
  <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" vector-effect="non-scaling-stroke" />
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;SETTINGS&quot;,&quot;label&quot;:null}" id="item-65afd1d1-e68f-488f-b050-54295ee22fb3" href="/settings/profile" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;DOCS&quot;,&quot;label&quot;:null}" id="item-f89a416f-6613-4374-bf54-c4ab575f75b7" href="https://docs.github.com" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;SUPPORT&quot;,&quot;label&quot;:null}" id="item-ecd19d2d-6085-4907-97af-773dcff6c2d7" href="https://support.github.com" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-people">
    <path d="M2 5.5a3.5 3.5 0 1 1 5.898 2.549 5.508 5.508 0 0 1 3.034 4.084.75.75 0 1 1-1.482.235 4 4 0 0 0-7.9 0 .75.75 0 0 1-1.482-.236A5.507 5.507 0 0 1 3.102 8.05 3.493 3.493 0 0 1 2 5.5ZM11 4a3.001 3.001 0 0 1 2.22 5.018 5.01 5.01 0 0 1 2.56 3.012.749.749 0 0 1-.885.954.752.752 0 0 1-.549-.514 3.507 3.507 0 0 0-2.522-2.372.75.75 0 0 1-.574-.73v-.352a.75.75 0 0 1 .416-.672A1.5 1.5 0 0 0 11 5.5.75.75 0 0 1 11 4Zm-5.5-.5a2 2 0 1 0-.001 3.999A2 2 0 0 0 5.5 3.5Z"></path>
</svg>
...
<li data-targets="nav-list.items nav-list.items" data-item-id="" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;LOGOUT&quot;,&quot;label&quot;:null}" id="item-bf669cf1-76ad-4ba9-b678-31783c25eea0" href="/logout" data-view-component="true" class="ActionListContent">
...
<site-header-logged-in-user-menu>
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-843faf46-5c67-4b09-98ee-dd11893078c4-button" popovertarget="action-menu-843faf46-5c67-4b09-98ee-dd11893078c4-overlay" aria-controls="action-menu-843faf46-5c67-4b09-98ee-dd11893078c4-list" aria-haspopup="true" aria-labelledby="tooltip-22df5d24-a793-44f6-95c1-423e9551572c" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-22df5d24-a793-44f6-95c1-423e9551572c" for="action-menu-843faf46-5c67-4b09-98ee-dd11893078c4-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position id="action-menu-843faf46-5c67-4b09-98ee-dd11893078c4-overlay" anchor="action-menu-843faf46-5c67-4b09-98ee-dd11893078c4-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <div data-view-component="true">
  <ul aria-labelledby="action-menu-843faf46-5c67-4b09-98ee-dd11893078c4-button" id="action-menu-843faf46-5c67-4b09-98ee-dd11893078c4-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
    ...
    <a tabindex="-1" id="item-1ecd5329-ccbd-44ab-9abb-8a7801109b9e" href="/gouthamvasam/Classical-Machine-Learning/tree/gouthamvasam-image-classification" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-code">
    <path d="m11.28 3.22 4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.275-.326.749.749 0 0 1 .215-.734L13.94 8l-3.72-3.72a.749.749 0 0 1 .326-1.275.749.749 0 0 1 .734.215Zm-6.56 0a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042L2.06 8l3.72 3.72a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L.47 8.53a.75.75 0 0 1 0-1.06Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-583c4d9d-4f80-4cc6-9140-c59520a1f43e" href="/gouthamvasam/Classical-Machine-Learning/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-fe0c3337-d952-4dae-87f8-6fcdfe23c9bb" href="/gouthamvasam/Classical-Machine-Learning/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-204a1f28-5ed0-4911-a332-32f0a6bff742" href="/gouthamvasam/Classical-Machine-Learning/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-dc5ff69a-9c60-4e2b-b317-ed9371a9ac5a" href="/gouthamvasam/Classical-Machine-Learning/projects" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-table">
    <path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v12.5A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25ZM6.5 6.5v8h7.75a.25.25 0 0 0 .25-.25V6.5Zm8-1.5V1.75a.25.25 0 0 0-.25-.25H6.5V5Zm-13 1.5v7.75c0 .138.112.25.25.25H5v-8ZM5 5V1.5H1.75a.25.25 0 0 0-.25.25V5Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-1fb22c3a-a63b-43f4-aebf-56e60ff2c553" href="/gouthamvasam/Classical-Machine-Learning/wiki" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-book">
    <path d="M0 1.75A.75.75 0 0 1 .75 1h4.253c1.227 0 2.317.59 3 1.501A3.743 3.743 0 0 1 11.006 1h4.245a.75.75 0 0 1 .75.75v10.5a.75.75 0 0 1-.75.75h-4.507a2.25 2.25 0 0 0-1.591.659l-.622.621a.75.75 0 0 1-1.06 0l-.622-.621A2.25 2.25 0 0 0 5.258 13H.75a.75.75 0 0 1-.75-.75Zm7.251 10.324.004-5.073-.002-2.253A2.25 2.25 0 0 0 5.003 2.5H1.5v9h3.757a3.75 3.75 0 0 1 1.994.574ZM8.755 4.75l-.004 7.322a3.752 3.752 0 0 1 1.992-.572H14.5v-9h-3.495a2.25 2.25 0 0 0-2.25 2.25Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-4e58c88c-e740-4b5c-8ea9-8d61d32bc29b" href="/gouthamvasam/Classical-Machine-Learning/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-ac19a0fe-2535-49a2-8f97-3b8e15da729a" href="/gouthamvasam/Classical-Machine-Learning/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-8f7acecd-b2f3-49c7-a605-bba0a0fd7ca3" href="/gouthamvasam/Classical-Machine-Learning/settings" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-gear">
    <path d="M8 0a8.2 8.2 0 0 1 .701.031C9.444.095 9.99.645 10.16 1.29l.288 1.107c.018.066.079.158.212.224.231.114.454.243.668.386.123.082.233.09.299.071l1.103-.303c.644-.176 1.392.021 1.82.63.27.385.506.792.704 1.218.315.675.111 1.422-.364 1.891l-.814.806c-.049.048-.098.147-.088.294.016.257.016.515 0 .772-.01.147.038.246.088.294l.814.806c.475.469.679 1.216.364 1.891a7.977 7.977 0 0 1-.704 1.217c-.428.61-1.176.807-1.82.63l-1.102-.302c-.067-.019-.177-.011-.3.071a5.909 5.909 0 0 1-.668.386c-.133.066-.194.158-.211.224l-.29 1.106c-.168.646-.715 1.196-1.458 1.26a8.006 8.006 0 0 1-1.402 0c-.743-.064-1.289-.614-1.458-1.26l-.289-1.106c-.018-.066-.079-.158-.212-.224a5.738 5.738 0 0 1-.668-.386c-.123-.082-.233-.09-.299-.071l-1.103.303c-.644.176-1.392-.021-1.82-.63a8.12 8.12 0 0 1-.704-1.218c-.315-.675-.111-1.422.363-1.891l.815-.806c.05-.048.098-.147.088-.294a6.214 6.214 0 0 1 0-.772c.01-.147-.038-.246-.088-.294l-.815-.806C.635 6.045.431 5.298.746 4.623a7.92 7.92 0 0 1 .704-1.217c.428-.61 1.176-.807 1.82-.63l1.102.302c.067.019.177.011.3-.071.214-.143.437-.272.668-.386.133-.066.194-.158.211-.224l.29-1.106C6.009.645 6.556.095 7.299.03 7.53.01 7.764 0 8 0Zm-.571 1.525c-.036.003-.108.036-.137.146l-.289 1.105c-.147.561-.549.967-.998 1.189-.173.086-.34.183-.5.29-.417.278-.97.423-1.529.27l-1.103-.303c-.109-.03-.175.016-.195.045-.22.312-.412.644-.573.99-.014.031-.021.11.059.19l.815.806c.411.406.562.957.53 1.456a4.709 4.709 0 0 0 0 .582c.032.499-.119 1.05-.53 1.456l-.815.806c-.081.08-.073.159-.059.19.162.346.353.677.573.989.02.03.085.076.195.046l1.102-.303c.56-.153 1.113-.008 1.53.27.161.107.328.204.501.29.447.222.85.629.997 1.189l.289 1.105c.029.109.101.143.137.146a6.6 6.6 0 0 0 1.142 0c.036-.003.108-.036.137-.146l.289-1.105c.147-.561.549-.967.998-1.189.173-.086.34-.183.5-.29.417-.278.97-.423 1.529-.27l1.103.303c.109.029.175-.016.195-.045.22-.313.411-.644.573-.99.014-.031.021-.11-.059-.19l-.815-.806c-.411-.406-.562-.957-.53-1.456a4.709 4.709 0 0 0 0-.582c-.032-.499.119-1.05.53-1.456l.815-.806c.081-.08.073-.159.059-.19a6.464 6.464 0 0 0-.573-.989c-.02-.03-.085-.076-.195-.046l-1.102.303c-.56.153-1.113.008-1.53-.27a4.44 4.44 0 0 0-.501-.29c-.447-.222-.85-.629-.997-1.189l-.289-1.105c-.029-.11-.101-.143-.137-.146a6.6 6.6 0 0 0-1.142 0ZM11 8a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM9.5 8a1.5 1.5 0 1 0-3.001.001A1.5 1.5 0 0 0 9.5 8Z"></path>
</svg>
    ...
    <button id="icon-button-e94eacf6-5dc2-4cf8-9c0c-2ea4a6f440a8" aria-labelledby="tooltip-8a26542d-5911-483c-9e7c-c5be31aeb919" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-8a26542d-5911-483c-9e7c-c5be31aeb919" for="icon-button-e94eacf6-5dc2-4cf8-9c0c-2ea4a6f440a8" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  <div class="px-2" >
    ...
    <notification-shelf-watcher data-base-url="https://github.com/notifications/beta/shelf" data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6OTgyNDUwNTgiLCJ0IjoxNzAyNTg2MDU4fQ==--13adaea0dc994e55d49722c682d08b7d4d1651c5a90b477bf6ad3eb19fcb450f" data-view-component="true" class="js-socket-channel"></notification-shelf-watcher>
...
>
  ...
  <details-dialog class="command-palette-details-dialog d-flex flex-column flex-justify-center height-fit" aria-label="Command palette">
    <command-palette
      ...
      return-to=/gouthamvasam/Classical-Machine-Learning/blob/gouthamvasam-image-classification/Train_Image%20classification_bag%20of%20visual%20words_SVM%2CRF%2CXGB.py
      user-id="98245058"
...
</button>    <tool-tip id="tooltip-425ae3f3-e9c7-41ca-a159-a2dcd0c934f4" for="command-palette-clear-button" popover="manual" data-direction="w" data-type="label" data-view-component="true" class="sr-only position-absolute">Clear Command Palette</tool-tip>
</div>
...
<react-app
  ...
  initial-path="/gouthamvasam/Classical-Machine-Learning/blob/gouthamvasam-image-classification/Train_Image%20classification_bag%20of%20visual%20words_SVM%2CRF%2CXGB.py"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":true,"fileTree":{"":{"items":[{"name":"README.md","path":"README.md","contentType":"file"},{"name":"Train_Image classification_bag of visual words_SVM,RF,XGB.py","path":"Train_Image classification_bag of visual words_SVM,RF,XGB.py","contentType":"file"},{"name":"Validate_Image classification_bag of visual words_SVM,RF,XGB.py","path":"Validate_Image classification_bag of visual words_SVM,RF,XGB.py","contentType":"file"}],"totalCount":3}},"fileTreeProcessingTime":2.059169,"foldersToFetch":[],"reducedMotionEnabled":"system","repo":{"id":455974399,"defaultBranch":"main","name":"Classical-Machine-Learning","ownerLogin":"gouthamvasam","currentUserCanPush":true,"isFork":false,"isEmpty":false,"createdAt":"2022-02-05T15:09:46.000-05:00","ownerAvatar":"https://avatars.githubusercontent.com/u/98245058?v=4","public":true,"private":false,"isOrgOwned":false},"symbolsExpanded":false,"treeExpanded":true,"refInfo":{"name":"gouthamvasam-image-classification","listCacheKey":"v0:1644092164.899216","canEdit":true,"refType":"branch","currentOid":"6deb77ab5b897dded5b32665c510367ebb190b49"},"path":"Train_Image classification_bag of visual words_SVM,RF,XGB.py","currentUser":{"id":98245058,"login":"gouthamvasam","userEmail":"gouthamvasam@gmail.com"},"blob":{"rawLines":["\"\"\"\r","The following code worked on Python 3.5.6; openCV 3.1.0; Spyder 3.3.1; sklearn 0.20.0; joblib 0.12.5 - created a custom environment of Anaconda - might not be possible on all computers.\r","All section images resized to 1000 x 1000.\r","Images used for test are completely different that the ones used for training.\r","696 and 768 test images for MVM- and MVM+, respectively.\r","3233 and 3534 train images for MVM- and MVM+, respectively.\r","\"\"\"\r","\r","\r","import cv2\r","import numpy as np\r","import os\r","\r","\r","# Get the training classes names and store them in a list\r","#Here we use folder names for class names\r","\r","#train_path = 'PE2_SVM_Divided_TT_70-30_8DA_1image/train'  # Names are MVM- and MVM+\r","train_path = 'PE2_SVM_Divided_TT_70-30_8DA_1image/train'  # Folder Names are MVM- and MVM+\r","training_names = os.listdir(train_path)\r","\r","# Get path to all images and save them in a list\r","# image_paths and the corresponding label in image_paths\r","image_paths = []\r","image_classes = []\r","class_id = 0\r","\r","#To make it easy to list all file names in a directory define a function\r","def imglist(path):    \r","    return [os.path.join(path, f) for f in os.listdir(path)]\r","\r","#Fill the placeholder empty lists with image path, classes, and add class ID number\r","    \r","for training_name in training_names:\r","    dir = os.path.join(train_path, training_name)\r","    class_path = imglist(dir)\r","    image_paths+=class_path\r","    image_classes+=[class_id]*len(class_path)\r","    class_id+=1\r","\r","# Create feature extraction and keypoint detector objects\r","#SIFT is not available anymore in openCV (patented- need to get a license?)   \r","# Create List where all the descriptors will be stored\r","des_list = []\r","\r","#BRISK is a good replacement to SIFT (patented - license needed). ORB also works - may need to try for this dataset.\r","#brisk = cv2.BRISK_create(250) #try 250 and 500 features\r","#orb = cv2.ORB_create(250) #try 250 and 500 features\r","sift = cv2.xfeatures2d.SIFT_create(500) #try 250 and 500 features\r","\r","for image_path in image_paths:\r","    im = cv2.imread(image_path)\r","    kpts, des = sift.detectAndCompute(im, None) \r","    des_list.append((image_path, des))\r","    \r","# Stack all the descriptors vertically in a numpy array\r","descriptors = des_list[0][1]\r","for image_path, descriptor in des_list[1:]:\r","    descriptors = np.vstack((descriptors, descriptor))  \r","\r","#kmeans works only on float, so convert integers to float\r","descriptors_float = descriptors.astype(float)  \r","\r","# Perform k-means clustering and vector quantization\r","from scipy.cluster.vq import kmeans, vq\r","\r","k = 100  #try kmeans with 100, 200 and (maybe 300) clusters\r","voc, variance = kmeans(descriptors_float, k, 1)\r","\r","# Calculate the histogram of features and represent them as vector\r","#vq Assigns codes from a code book to observations.\r","im_features = np.zeros((len(image_paths), k), \"float32\")\r","for i in range(len(image_paths)):\r","    words, distance = vq(des_list[i][1],voc)\r","    for w in words:\r","        im_features[i][w] += 1\r","\r","# Perform Tf-Idf vectorization\r","nbr_occurences = np.sum((im_features \u003e 0) * 1, axis = 0)\r","idf = np.array(np.log((1.0*len(image_paths)+1) / (1.0*nbr_occurences + 1)), 'float32')\r","\r","# Scaling the words\r","#Standardize features by removing the mean and scaling to unit variance\r","#In a way normalization\r","from sklearn.preprocessing import StandardScaler\r","stdSlr = StandardScaler().fit(im_features)\r","im_features = stdSlr.transform(im_features)\r","\r","#Train an algorithm to discriminate vectors corresponding to positive and negative training images\r","\r","#Train the Linear SVM\r","#from sklearn.svm import LinearSVC\r","#clf = LinearSVC(max_iter=10000)  #Default of 100 is not converging\r","#clf.fit(im_features, np.array(image_classes))\r","\r","#Train Random forest to compare how it does against SVM\r","#from sklearn.ensemble import RandomForestClassifier\r","#clf = RandomForestClassifier(n_estimators = 200, random_state=42) #try 100 and 200 estimators\r","#clf.fit(im_features, np.array(image_classes))\r","\r","#Train the xgboost to compare how it does against SVM and RF\r","from xgboost import XGBClassifier\r","clf = XGBClassifier(n_estimators = 200) #try n_estimators = 200; the default is 100\r","clf.fit(im_features, np.array(image_classes))\r","\r","\r","# Save the SVM or RF, change pkl file name accordingly\r","#Joblib dumps Python object into one file\r","from sklearn.externals import joblib\r","joblib.dump((clf, training_names, stdSlr, k, voc), \"PE2_DA_bovw_sift500_km100_XGB200.pkl\", compress=3)"],"stylingDirectives":[[{"start":0,"end":4,"cssClass":"pl-s"}],[{"start":0,"end":186,"cssClass":"pl-s"}],[{"start":0,"end":43,"cssClass":"pl-s"}],[{"start":0,"end":79,"cssClass":"pl-s"}],[{"start":0,"end":57,"cssClass":"pl-s"}],[{"start":0,"end":60,"cssClass":"pl-s"}],[{"start":0,"end":3,"cssClass":"pl-s"}],[],[],[{"start":0,"end":6,"cssClass":"pl-k"},{"start":7,"end":10,"cssClass":"pl-s1"}],[{"start":0,"end":6,"cssClass":"pl-k"},{"start":7,"end":12,"cssClass":"pl-s1"},{"start":13,"end":15,"cssClass":"pl-k"},{"start":16,"end":18,"cssClass":"pl-s1"}],[{"start":0,"end":6,"cssClass":"pl-k"},{"start":7,"end":9,"cssClass":"pl-s1"}],[],[],[{"start":0,"end":58,"cssClass":"pl-c"}],[{"start":0,"end":42,"cssClass":"pl-c"}],[],[{"start":0,"end":85,"cssClass":"pl-c"}],[{"start":0,"end":10,"cssClass":"pl-s1"},{"start":11,"end":12,"cssClass":"pl-c1"},{"start":13,"end":56,"cssClass":"pl-s"},{"start":58,"end":91,"cssClass":"pl-c"}],[{"start":0,"end":14,"cssClass":"pl-s1"},{"start":15,"end":16,"cssClass":"pl-c1"},{"start":17,"end":19,"cssClass":"pl-s1"},{"start":20,"end":27,"cssClass":"pl-en"},{"start":28,"end":38,"cssClass":"pl-s1"}],[],[{"start":0,"end":49,"cssClass":"pl-c"}],[{"start":0,"end":57,"cssClass":"pl-c"}],[{"start":0,"end":11,"cssClass":"pl-s1"},{"start":12,"end":13,"cssClass":"pl-c1"}],[{"start":0,"end":13,"cssClass":"pl-s1"},{"start":14,"end":15,"cssClass":"pl-c1"}],[{"start":0,"end":8,"cssClass":"pl-s1"},{"start":9,"end":10,"cssClass":"pl-c1"},{"start":11,"end":12,"cssClass":"pl-c1"}],[],[{"start":0,"end":73,"cssClass":"pl-c"}],[{"start":0,"end":3,"cssClass":"pl-k"},{"start":4,"end":11,"cssClass":"pl-en"},{"start":12,"end":16,"cssClass":"pl-s1"}],[{"start":4,"end":10,"cssClass":"pl-k"},{"start":12,"end":14,"cssClass":"pl-s1"},{"start":15,"end":19,"cssClass":"pl-s1"},{"start":20,"end":24,"cssClass":"pl-en"},{"start":25,"end":29,"cssClass":"pl-s1"},{"start":31,"end":32,"cssClass":"pl-s1"},{"start":34,"end":37,"cssClass":"pl-k"},{"start":38,"end":39,"cssClass":"pl-s1"},{"start":40,"end":42,"cssClass":"pl-c1"},{"start":43,"end":45,"cssClass":"pl-s1"},{"start":46,"end":53,"cssClass":"pl-en"},{"start":54,"end":58,"cssClass":"pl-s1"}],[],[{"start":0,"end":84,"cssClass":"pl-c"}],[],[{"start":0,"end":3,"cssClass":"pl-k"},{"start":4,"end":17,"cssClass":"pl-s1"},{"start":18,"end":20,"cssClass":"pl-c1"},{"start":21,"end":35,"cssClass":"pl-s1"}],[{"start":4,"end":7,"cssClass":"pl-s1"},{"start":8,"end":9,"cssClass":"pl-c1"},{"start":10,"end":12,"cssClass":"pl-s1"},{"start":13,"end":17,"cssClass":"pl-s1"},{"start":18,"end":22,"cssClass":"pl-en"},{"start":23,"end":33,"cssClass":"pl-s1"},{"start":35,"end":48,"cssClass":"pl-s1"}],[{"start":4,"end":14,"cssClass":"pl-s1"},{"start":15,"end":16,"cssClass":"pl-c1"},{"start":17,"end":24,"cssClass":"pl-en"},{"start":25,"end":28,"cssClass":"pl-s1"}],[{"start":4,"end":15,"cssClass":"pl-s1"},{"start":15,"end":17,"cssClass":"pl-c1"},{"start":17,"end":27,"cssClass":"pl-s1"}],[{"start":4,"end":17,"cssClass":"pl-s1"},{"start":17,"end":19,"cssClass":"pl-c1"},{"start":20,"end":28,"cssClass":"pl-s1"},{"start":29,"end":30,"cssClass":"pl-c1"},{"start":30,"end":33,"cssClass":"pl-en"},{"start":34,"end":44,"cssClass":"pl-s1"}],[{"start":4,"end":12,"cssClass":"pl-s1"},{"start":12,"end":14,"cssClass":"pl-c1"},{"start":14,"end":15,"cssClass":"pl-c1"}],[],[{"start":0,"end":58,"cssClass":"pl-c"}],[{"start":0,"end":79,"cssClass":"pl-c"}],[{"start":0,"end":55,"cssClass":"pl-c"}],[{"start":0,"end":8,"cssClass":"pl-s1"},{"start":9,"end":10,"cssClass":"pl-c1"}],[],[{"start":0,"end":117,"cssClass":"pl-c"}],[{"start":0,"end":57,"cssClass":"pl-c"}],[{"start":0,"end":53,"cssClass":"pl-c"}],[{"start":0,"end":4,"cssClass":"pl-s1"},{"start":5,"end":6,"cssClass":"pl-c1"},{"start":7,"end":10,"cssClass":"pl-s1"},{"start":11,"end":22,"cssClass":"pl-s1"},{"start":23,"end":34,"cssClass":"pl-v"},{"start":35,"end":38,"cssClass":"pl-c1"},{"start":40,"end":66,"cssClass":"pl-c"}],[],[{"start":0,"end":3,"cssClass":"pl-k"},{"start":4,"end":14,"cssClass":"pl-s1"},{"start":15,"end":17,"cssClass":"pl-c1"},{"start":18,"end":29,"cssClass":"pl-s1"}],[{"start":4,"end":6,"cssClass":"pl-s1"},{"start":7,"end":8,"cssClass":"pl-c1"},{"start":9,"end":12,"cssClass":"pl-s1"},{"start":13,"end":19,"cssClass":"pl-en"},{"start":20,"end":30,"cssClass":"pl-s1"}],[{"start":4,"end":8,"cssClass":"pl-s1"},{"start":10,"end":13,"cssClass":"pl-s1"},{"start":14,"end":15,"cssClass":"pl-c1"},{"start":16,"end":20,"cssClass":"pl-s1"},{"start":21,"end":37,"cssClass":"pl-en"},{"start":38,"end":40,"cssClass":"pl-s1"},{"start":42,"end":46,"cssClass":"pl-c1"}],[{"start":4,"end":12,"cssClass":"pl-s1"},{"start":13,"end":19,"cssClass":"pl-en"},{"start":21,"end":31,"cssClass":"pl-s1"},{"start":33,"end":36,"cssClass":"pl-s1"}],[],[{"start":0,"end":56,"cssClass":"pl-c"}],[{"start":0,"end":11,"cssClass":"pl-s1"},{"start":12,"end":13,"cssClass":"pl-c1"},{"start":14,"end":22,"cssClass":"pl-s1"},{"start":23,"end":24,"cssClass":"pl-c1"},{"start":26,"end":27,"cssClass":"pl-c1"}],[{"start":0,"end":3,"cssClass":"pl-k"},{"start":4,"end":14,"cssClass":"pl-s1"},{"start":16,"end":26,"cssClass":"pl-s1"},{"start":27,"end":29,"cssClass":"pl-c1"},{"start":30,"end":38,"cssClass":"pl-s1"},{"start":39,"end":40,"cssClass":"pl-c1"}],[{"start":4,"end":15,"cssClass":"pl-s1"},{"start":16,"end":17,"cssClass":"pl-c1"},{"start":18,"end":20,"cssClass":"pl-s1"},{"start":21,"end":27,"cssClass":"pl-en"},{"start":29,"end":40,"cssClass":"pl-s1"},{"start":42,"end":52,"cssClass":"pl-s1"}],[],[{"start":0,"end":58,"cssClass":"pl-c"}],[{"start":0,"end":17,"cssClass":"pl-s1"},{"start":18,"end":19,"cssClass":"pl-c1"},{"start":20,"end":31,"cssClass":"pl-s1"},{"start":32,"end":38,"cssClass":"pl-en"},{"start":39,"end":44,"cssClass":"pl-s1"}],[],[{"start":0,"end":53,"cssClass":"pl-c"}],[{"start":0,"end":4,"cssClass":"pl-k"},{"start":5,"end":10,"cssClass":"pl-s1"},{"start":11,"end":18,"cssClass":"pl-s1"},{"start":19,"end":21,"cssClass":"pl-s1"},{"start":22,"end":28,"cssClass":"pl-k"},{"start":29,"end":35,"cssClass":"pl-s1"},{"start":37,"end":39,"cssClass":"pl-s1"}],[],[{"start":0,"end":1,"cssClass":"pl-s1"},{"start":2,"end":3,"cssClass":"pl-c1"},{"start":4,"end":7,"cssClass":"pl-c1"},{"start":9,"end":60,"cssClass":"pl-c"}],[{"start":0,"end":3,"cssClass":"pl-s1"},{"start":5,"end":13,"cssClass":"pl-s1"},{"start":14,"end":15,"cssClass":"pl-c1"},{"start":16,"end":22,"cssClass":"pl-en"},{"start":23,"end":40,"cssClass":"pl-s1"},{"start":42,"end":43,"cssClass":"pl-s1"},{"start":45,"end":46,"cssClass":"pl-c1"}],[],[{"start":0,"end":67,"cssClass":"pl-c"}],[{"start":0,"end":52,"cssClass":"pl-c"}],[{"start":0,"end":11,"cssClass":"pl-s1"},{"start":12,"end":13,"cssClass":"pl-c1"},{"start":14,"end":16,"cssClass":"pl-s1"},{"start":17,"end":22,"cssClass":"pl-en"},{"start":24,"end":27,"cssClass":"pl-en"},{"start":28,"end":39,"cssClass":"pl-s1"},{"start":42,"end":43,"cssClass":"pl-s1"},{"start":46,"end":55,"cssClass":"pl-s"}],[{"start":0,"end":3,"cssClass":"pl-k"},{"start":4,"end":5,"cssClass":"pl-s1"},{"start":6,"end":8,"cssClass":"pl-c1"},{"start":9,"end":14,"cssClass":"pl-en"},{"start":15,"end":18,"cssClass":"pl-en"},{"start":19,"end":30,"cssClass":"pl-s1"}],[{"start":4,"end":9,"cssClass":"pl-s1"},{"start":11,"end":19,"cssClass":"pl-s1"},{"start":20,"end":21,"cssClass":"pl-c1"},{"start":22,"end":24,"cssClass":"pl-en"},{"start":25,"end":33,"cssClass":"pl-s1"},{"start":34,"end":35,"cssClass":"pl-s1"},{"start":37,"end":38,"cssClass":"pl-c1"},{"start":40,"end":43,"cssClass":"pl-s1"}],[{"start":4,"end":7,"cssClass":"pl-k"},{"start":8,"end":9,"cssClass":"pl-s1"},{"start":10,"end":12,"cssClass":"pl-c1"},{"start":13,"end":18,"cssClass":"pl-s1"}],[{"start":8,"end":19,"cssClass":"pl-s1"},{"start":20,"end":21,"cssClass":"pl-s1"},{"start":23,"end":24,"cssClass":"pl-s1"},{"start":26,"end":28,"cssClass":"pl-c1"},{"start":29,"end":30,"cssClass":"pl-c1"}],[],[{"start":0,"end":31,"cssClass":"pl-c"}],[{"start":0,"end":14,"cssClass":"pl-s1"},{"start":15,"end":16,"cssClass":"pl-c1"},{"start":17,"end":19,"cssClass":"pl-s1"},{"start":20,"end":23,"cssClass":"pl-en"},{"start":25,"end":36,"cssClass":"pl-s1"},{"start":37,"end":38,"cssClass":"pl-c1"},{"start":39,"end":40,"cssClass":"pl-c1"},{"start":42,"end":43,"cssClass":"pl-c1"},{"start":44,"end":45,"cssClass":"pl-c1"},{"start":47,"end":51,"cssClass":"pl-s1"},{"start":52,"end":53,"cssClass":"pl-c1"},{"start":54,"end":55,"cssClass":"pl-c1"}],[{"start":0,"end":3,"cssClass":"pl-s1"},{"start":4,"end":5,"cssClass":"pl-c1"},{"start":6,"end":8,"cssClass":"pl-s1"},{"start":9,"end":14,"cssClass":"pl-en"},{"start":15,"end":17,"cssClass":"pl-s1"},{"start":18,"end":21,"cssClass":"pl-en"},{"start":23,"end":26,"cssClass":"pl-c1"},{"start":26,"end":27,"cssClass":"pl-c1"},{"start":27,"end":30,"cssClass":"pl-en"},{"start":31,"end":42,"cssClass":"pl-s1"},{"start":43,"end":44,"cssClass":"pl-c1"},{"start":44,"end":45,"cssClass":"pl-c1"},{"start":47,"end":48,"cssClass":"pl-c1"},{"start":50,"end":53,"cssClass":"pl-c1"},{"start":53,"end":54,"cssClass":"pl-c1"},{"start":54,"end":68,"cssClass":"pl-s1"},{"start":69,"end":70,"cssClass":"pl-c1"},{"start":71,"end":72,"cssClass":"pl-c1"},{"start":76,"end":85,"cssClass":"pl-s"}],[],[{"start":0,"end":20,"cssClass":"pl-c"}],[{"start":0,"end":72,"cssClass":"pl-c"}],[{"start":0,"end":24,"cssClass":"pl-c"}],[{"start":0,"end":4,"cssClass":"pl-k"},{"start":5,"end":12,"cssClass":"pl-s1"},{"start":13,"end":26,"cssClass":"pl-s1"},{"start":27,"end":33,"cssClass":"pl-k"},{"start":34,"end":48,"cssClass":"pl-v"}],[{"start":0,"end":6,"cssClass":"pl-s1"},{"start":7,"end":8,"cssClass":"pl-c1"},{"start":9,"end":23,"cssClass":"pl-v"},{"start":26,"end":29,"cssClass":"pl-en"},{"start":30,"end":41,"cssClass":"pl-s1"}],[{"start":0,"end":11,"cssClass":"pl-s1"},{"start":12,"end":13,"cssClass":"pl-c1"},{"start":14,"end":20,"cssClass":"pl-s1"},{"start":21,"end":30,"cssClass":"pl-en"},{"start":31,"end":42,"cssClass":"pl-s1"}],[],[{"start":0,"end":99,"cssClass":"pl-c"}],[],[{"start":0,"end":22,"cssClass":"pl-c"}],[{"start":0,"end":35,"cssClass":"pl-c"}],[{"start":0,"end":68,"cssClass":"pl-c"}],[{"start":0,"end":47,"cssClass":"pl-c"}],[],[{"start":0,"end":56,"cssClass":"pl-c"}],[{"start":0,"end":53,"cssClass":"pl-c"}],[{"start":0,"end":95,"cssClass":"pl-c"}],[{"start":0,"end":47,"cssClass":"pl-c"}],[],[{"start":0,"end":61,"cssClass":"pl-c"}],[{"start":0,"end":4,"cssClass":"pl-k"},{"start":5,"end":12,"cssClass":"pl-s1"},{"start":13,"end":19,"cssClass":"pl-k"},{"start":20,"end":33,"cssClass":"pl-v"}],[{"start":0,"end":3,"cssClass":"pl-s1"},{"start":4,"end":5,"cssClass":"pl-c1"},{"start":6,"end":19,"cssClass":"pl-v"},{"start":20,"end":32,"cssClass":"pl-s1"},{"start":33,"end":34,"cssClass":"pl-c1"},{"start":35,"end":38,"cssClass":"pl-c1"},{"start":40,"end":84,"cssClass":"pl-c"}],[{"start":0,"end":3,"cssClass":"pl-s1"},{"start":4,"end":7,"cssClass":"pl-en"},{"start":8,"end":19,"cssClass":"pl-s1"},{"start":21,"end":23,"cssClass":"pl-s1"},{"start":24,"end":29,"cssClass":"pl-en"},{"start":30,"end":43,"cssClass":"pl-s1"}],[],[],[{"start":0,"end":55,"cssClass":"pl-c"}],[{"start":0,"end":42,"cssClass":"pl-c"}],[{"start":0,"end":4,"cssClass":"pl-k"},{"start":5,"end":12,"cssClass":"pl-s1"},{"start":13,"end":22,"cssClass":"pl-s1"},{"start":23,"end":29,"cssClass":"pl-k"},{"start":30,"end":36,"cssClass":"pl-s1"}],[{"start":0,"end":6,"cssClass":"pl-s1"},{"start":7,"end":11,"cssClass":"pl-en"},{"start":13,"end":16,"cssClass":"pl-s1"},{"start":18,"end":32,"cssClass":"pl-s1"},{"start":34,"end":40,"cssClass":"pl-s1"},{"start":42,"end":43,"cssClass":"pl-s1"},{"start":45,"end":48,"cssClass":"pl-s1"},{"start":51,"end":89,"cssClass":"pl-s"},{"start":91,"end":99,"cssClass":"pl-s1"},{"start":99,"end":100,"cssClass":"pl-c1"},{"start":100,"end":101,"cssClass":"pl-c1"}]],"csv":null,"csvError":null,"dependabotInfo":{"showConfigurationBanner":null,"configFilePath":null,"networkDependabotPath":"/gouthamvasam/Classical-Machine-Learning/network/updates","dismissConfigurationNoticePath":"/settings/dismiss-notice/dependabot_configuration_notice","configurationNoticeDismissed":false,"repoAlertsPath":"/gouthamvasam/Classical-Machine-Learning/security/dependabot","repoSecurityAndAnalysisPath":"/gouthamvasam/Classical-Machine-Learning/settings/security_analysis","repoOwnerIsOrg":false,"currentUserCanAdminRepo":true},"displayName":"Train_Image classification_bag of visual words_SVM,RF,XGB.py","displayUrl":"https://github.com/gouthamvasam/Classical-Machine-Learning/blob/gouthamvasam-image-classification/Train_Image%20classification_bag%20of%20visual%20words_SVM,RF,XGB.py?raw=true","headerInfo":{"blobSize":"4.29 KB","deleteInfo":{"deleteTooltip":"Delete this file"},"editInfo":{"editTooltip":"Edit this file"},"ghDesktopPath":"https://desktop.github.com","gitLfsPath":null,"onBranch":true,"shortPath":"fd58578","siteNavLoginPath":"/login?return_to=https%3A%2F%2Fgithub.com%2Fgouthamvasam%2FClassical-Machine-Learning%2Fblob%2Fgouthamvasam-image-classification%2FTrain_Image%2520classification_bag%2520of%2520visual%2520words_SVM%252CRF%252CXGB.py","isCSV":false,"isRichtext":false,"toc":null,"lineInfo":{"truncatedLoc":"110","truncatedSloc":"85"},"mode":"file"},"image":false,"isCodeownersFile":null,"isPlain":false,"isValidLegacyIssueTemplate":false,"issueTemplateHelpUrl":"https://docs.github.com/articles/about-issue-and-pull-request-templates","issueTemplate":null,"discussionTemplate":null,"language":"Python","languageID":303,"large":false,"loggedIn":true,"newDiscussionPath":"/gouthamvasam/Classical-Machine-Learning/discussions/new","newIssuePath":"/gouthamvasam/Classical-Machine-Learning/issues/new","planSupportInfo":{"repoIsFork":null,"repoOwnedByCurrentUser":null,"requestFullPath":"/gouthamvasam/Classical-Machine-Learning/blob/gouthamvasam-image-classification/Train_Image%20classification_bag%20of%20visual%20words_SVM%2CRF%2CXGB.py","showFreeOrgGatedFeatureMessage":null,"showPlanSupportBanner":null,"upgradeDataAttributes":null,"upgradePath":null},"publishBannersInfo":{"dismissActionNoticePath":"/settings/dismiss-notice/publish_action_from_dockerfile","dismissStackNoticePath":"/settings/dismiss-notice/publish_stack_from_file","releasePath":"/gouthamvasam/Classical-Machine-Learning/releases/new?marketplace=true","showPublishActionBanner":false,"showPublishStackBanner":false},"rawBlobUrl":"https://github.com/gouthamvasam/Classical-Machine-Learning/raw/gouthamvasam-image-classification/Train_Image%20classification_bag%20of%20visual%20words_SVM,RF,XGB.py","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"tabSize":8,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"repoOwner":"gouthamvasam","repoName":"Classical-Machine-Learning","showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/en/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","showDependabotConfigurationBanner":null,"actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timedOut":false,"notAnalyzed":false,"symbols":[{"name":"train_path","kind":"constant","identStart":681,"identEnd":691,"extentStart":681,"extentEnd":737,"fullyQualifiedName":"train_path","identUtf16":{"start":{"lineNumber":18,"utf16Col":0},"end":{"lineNumber":18,"utf16Col":10}},"extentUtf16":{"start":{"lineNumber":18,"utf16Col":0},"end":{"lineNumber":18,"utf16Col":56}}},{"name":"training_names","kind":"constant","identStart":773,"identEnd":787,"extentStart":773,"extentEnd":812,"fullyQualifiedName":"training_names","identUtf16":{"start":{"lineNumber":19,"utf16Col":0},"end":{"lineNumber":19,"utf16Col":14}},"extentUtf16":{"start":{"lineNumber":19,"utf16Col":0},"end":{"lineNumber":19,"utf16Col":39}}},{"name":"image_paths","kind":"constant","identStart":924,"identEnd":935,"extentStart":924,"extentEnd":940,"fullyQualifiedName":"image_paths","identUtf16":{"start":{"lineNumber":23,"utf16Col":0},"end":{"lineNumber":23,"utf16Col":11}},"extentUtf16":{"start":{"lineNumber":23,"utf16Col":0},"end":{"lineNumber":23,"utf16Col":16}}},{"name":"image_classes","kind":"constant","identStart":942,"identEnd":955,"extentStart":942,"extentEnd":960,"fullyQualifiedName":"image_classes","identUtf16":{"start":{"lineNumber":24,"utf16Col":0},"end":{"lineNumber":24,"utf16Col":13}},"extentUtf16":{"start":{"lineNumber":24,"utf16Col":0},"end":{"lineNumber":24,"utf16Col":18}}},{"name":"class_id","kind":"constant","identStart":962,"identEnd":970,"extentStart":962,"extentEnd":974,"fullyQualifiedName":"class_id","identUtf16":{"start":{"lineNumber":25,"utf16Col":0},"end":{"lineNumber":25,"utf16Col":8}},"extentUtf16":{"start":{"lineNumber":25,"utf16Col":0},"end":{"lineNumber":25,"utf16Col":12}}},{"name":"imglist","kind":"function","identStart":1056,"identEnd":1063,"extentStart":1052,"extentEnd":1136,"fullyQualifiedName":"imglist","identUtf16":{"start":{"lineNumber":28,"utf16Col":4},"end":{"lineNumber":28,"utf16Col":11}},"extentUtf16":{"start":{"lineNumber":28,"utf16Col":0},"end":{"lineNumber":29,"utf16Col":60}}},{"name":"des_list","kind":"constant","identStart":1641,"identEnd":1649,"extentStart":1641,"extentEnd":1654,"fullyQualifiedName":"des_list","identUtf16":{"start":{"lineNumber":43,"utf16Col":0},"end":{"lineNumber":43,"utf16Col":8}},"extentUtf16":{"start":{"lineNumber":43,"utf16Col":0},"end":{"lineNumber":43,"utf16Col":13}}},{"name":"sift","kind":"constant","identStart":1888,"identEnd":1892,"extentStart":1888,"extentEnd":1927,"fullyQualifiedName":"sift","identUtf16":{"start":{"lineNumber":48,"utf16Col":0},"end":{"lineNumber":48,"utf16Col":4}},"extentUtf16":{"start":{"lineNumber":48,"utf16Col":0},"end":{"lineNumber":48,"utf16Col":39}}},{"name":"descriptors","kind":"constant","identStart":2175,"identEnd":2186,"extentStart":2175,"extentEnd":2203,"fullyQualifiedName":"descriptors","identUtf16":{"start":{"lineNumber":56,"utf16Col":0},"end":{"lineNumber":56,"utf16Col":11}},"extentUtf16":{"start":{"lineNumber":56,"utf16Col":0},"end":{"lineNumber":56,"utf16Col":28}}},{"name":"descriptors_float","kind":"constant","identStart":2369,"identEnd":2386,"extentStart":2369,"extentEnd":2414,"fullyQualifiedName":"descriptors_float","identUtf16":{"start":{"lineNumber":61,"utf16Col":0},"end":{"lineNumber":61,"utf16Col":17}},"extentUtf16":{"start":{"lineNumber":61,"utf16Col":0},"end":{"lineNumber":61,"utf16Col":45}}},{"name":"k","kind":"constant","identStart":2517,"identEnd":2518,"extentStart":2517,"extentEnd":2524,"fullyQualifiedName":"k","identUtf16":{"start":{"lineNumber":66,"utf16Col":0},"end":{"lineNumber":66,"utf16Col":1}},"extentUtf16":{"start":{"lineNumber":66,"utf16Col":0},"end":{"lineNumber":66,"utf16Col":7}}},{"name":"im_features","kind":"constant","identStart":2750,"identEnd":2761,"extentStart":2750,"extentEnd":2806,"fullyQualifiedName":"im_features","identUtf16":{"start":{"lineNumber":71,"utf16Col":0},"end":{"lineNumber":71,"utf16Col":11}},"extentUtf16":{"start":{"lineNumber":71,"utf16Col":0},"end":{"lineNumber":71,"utf16Col":56}}},{"name":"nbr_occurences","kind":"constant","identStart":2976,"identEnd":2990,"extentStart":2976,"extentEnd":3032,"fullyQualifiedName":"nbr_occurences","identUtf16":{"start":{"lineNumber":78,"utf16Col":0},"end":{"lineNumber":78,"utf16Col":14}},"extentUtf16":{"start":{"lineNumber":78,"utf16Col":0},"end":{"lineNumber":78,"utf16Col":56}}},{"name":"idf","kind":"constant","identStart":3034,"identEnd":3037,"extentStart":3034,"extentEnd":3120,"fullyQualifiedName":"idf","identUtf16":{"start":{"lineNumber":79,"utf16Col":0},"end":{"lineNumber":79,"utf16Col":3}},"extentUtf16":{"start":{"lineNumber":79,"utf16Col":0},"end":{"lineNumber":79,"utf16Col":86}}},{"name":"stdSlr","kind":"constant","identStart":3293,"identEnd":3299,"extentStart":3293,"extentEnd":3335,"fullyQualifiedName":"stdSlr","identUtf16":{"start":{"lineNumber":85,"utf16Col":0},"end":{"lineNumber":85,"utf16Col":6}},"extentUtf16":{"start":{"lineNumber":85,"utf16Col":0},"end":{"lineNumber":85,"utf16Col":42}}},{"name":"im_features","kind":"constant","identStart":3337,"identEnd":3348,"extentStart":3337,"extentEnd":3380,"fullyQualifiedName":"im_features","identUtf16":{"start":{"lineNumber":86,"utf16Col":0},"end":{"lineNumber":86,"utf16Col":11}},"extentUtf16":{"start":{"lineNumber":86,"utf16Col":0},"end":{"lineNumber":86,"utf16Col":43}}},{"name":"clf","kind":"constant","identStart":4018,"identEnd":4021,"extentStart":4018,"extentEnd":4057,"fullyQualifiedName":"clf","identUtf16":{"start":{"lineNumber":102,"utf16Col":0},"end":{"lineNumber":102,"utf16Col":3}},"extentUtf16":{"start":{"lineNumber":102,"utf16Col":0},"end":{"lineNumber":102,"utf16Col":39}}}]}},"copilotInfo":{"documentationUrl":"https://docs.github.com/copilot/overview-of-github-copilot/about-github-copilot-for-individuals","notices":{"codeViewPopover":{"dismissed":false,"dismissPath":"/settings/dismiss-notice/code_view_copilot_popover"}},"userAccess":{"accessAllowed":false,"hasSubscriptionEnded":false,"orgHasCFBAccess":false,"userHasCFIAccess":false,"userHasOrgs":false,"userIsOrgAdmin":false,"userIsOrgMember":false,"business":null,"featureRequestInfo":null}},"copilotAccessAllowed":false,"csrf_tokens":{"/gouthamvasam/Classical-Machine-Learning/branches":{"post":"DKhJ3ZRYpb9EdW3kGSB7Y-Dweaw_rv_ArUYZZbVNqxZuzGTXGF3AIlEGO8jvqIirwypDMAk-NmlQHbRzHydvNg"},"/repos/preferences":{"post":"263UvfWk1pa3XqrfQUqgEWzx_21ddUFpzcvdNaYdeidGmiF3CV71G0IAd21WQYjffZtDIHxEdqoiO_qnRTJO0g"}}},"title":"Classical-Machine-Learning/Train_Image classification_bag of visual words_SVM,RF,XGB.py at gouthamvasam-image-classification · gouthamvasam/Classical-Machine-Learning","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-32bb159cc57c.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-ce6d5c15d2a1.js","githubDevUrl":"https://github.dev/","enabled_features":{"code_nav_ui_events":false,"copilot_conversational_ux":false,"copilot_conversational_ux_embedding_update":false,"copilot_conversational_ux_streaming":true,"copilot_popover_file_editor_header":true,"copilot_smell_icebreaker_ux":false}}}</script>
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC10" class="react-file-line html-div" data-testid="code-cell" data-line-number="10" style="position:relative"><span class="pl-k">import</span> <span class="pl-s1">cv2</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC11" class="react-file-line html-div" data-testid="code-cell" data-line-number="11" style="position:relative"><span class="pl-k">import</span> <span class="pl-s1">numpy</span> <span class="pl-k">as</span> <span class="pl-s1">np</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC12" class="react-file-line html-div" data-testid="code-cell" data-line-number="12" style="position:relative"><span class="pl-k">import</span> <span class="pl-s1">os</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC13" class="react-file-line html-div" data-testid="code-cell" data-line-number="13" style="position:relative">
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC15" class="react-file-line html-div" data-testid="code-cell" data-line-number="15" style="position:relative"><span class="pl-c"># Get the training classes names and store them in a list</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC16" class="react-file-line html-div" data-testid="code-cell" data-line-number="16" style="position:relative"><span class="pl-c">#Here we use folder names for class names</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC17" class="react-file-line html-div" data-testid="code-cell" data-line-number="17" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC18" class="react-file-line html-div" data-testid="code-cell" data-line-number="18" style="position:relative"><span class="pl-c">#train_path = &#039;PE2_SVM_Divided_TT_70-30_8DA_1image/train&#039;  # Names are MVM- and MVM+</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC19" class="react-file-line html-div" data-testid="code-cell" data-line-number="19" style="position:relative"><span class="pl-s1">train_path</span> <span class="pl-c1">=</span> <span class="pl-s">&#039;PE2_SVM_Divided_TT_70-30_8DA_1image/train&#039;</span>  <span class="pl-c"># Folder Names are MVM- and MVM+</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC20" class="react-file-line html-div" data-testid="code-cell" data-line-number="20" style="position:relative"><span class="pl-s1">training_names</span> <span class="pl-c1">=</span> <span class="pl-s1">os</span>.<span class="pl-en">listdir</span>(<span class="pl-s1">train_path</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC21" class="react-file-line html-div" data-testid="code-cell" data-line-number="21" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC22" class="react-file-line html-div" data-testid="code-cell" data-line-number="22" style="position:relative"><span class="pl-c"># Get path to all images and save them in a list</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC23" class="react-file-line html-div" data-testid="code-cell" data-line-number="23" style="position:relative"><span class="pl-c"># image_paths and the corresponding label in image_paths</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC24" class="react-file-line html-div" data-testid="code-cell" data-line-number="24" style="position:relative"><span class="pl-s1">image_paths</span> <span class="pl-c1">=</span> []</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC25" class="react-file-line html-div" data-testid="code-cell" data-line-number="25" style="position:relative"><span class="pl-s1">image_classes</span> <span class="pl-c1">=</span> []</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC26" class="react-file-line html-div" data-testid="code-cell" data-line-number="26" style="position:relative"><span class="pl-s1">class_id</span> <span class="pl-c1">=</span> <span class="pl-c1">0</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC27" class="react-file-line html-div" data-testid="code-cell" data-line-number="27" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC28" class="react-file-line html-div" data-testid="code-cell" data-line-number="28" style="position:relative"><span class="pl-c">#To make it easy to list all file names in a directory define a function</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC29" class="react-file-line html-div" data-testid="code-cell" data-line-number="29" style="position:relative"><span class="pl-k">def</span> <span class="pl-en">imglist</span>(<span class="pl-s1">path</span>):    </div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC30" class="react-file-line html-div" data-testid="code-cell" data-line-number="30" style="position:relative">    <span class="pl-k">return</span> [<span class="pl-s1">os</span>.<span class="pl-s1">path</span>.<span class="pl-en">join</span>(<span class="pl-s1">path</span>, <span class="pl-s1">f</span>) <span class="pl-k">for</span> <span class="pl-s1">f</span> <span class="pl-c1">in</span> <span class="pl-s1">os</span>.<span class="pl-en">listdir</span>(<span class="pl-s1">path</span>)]</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC31" class="react-file-line html-div" data-testid="code-cell" data-line-number="31" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC32" class="react-file-line html-div" data-testid="code-cell" data-line-number="32" style="position:relative"><span class="pl-c">#Fill the placeholder empty lists with image path, classes, and add class ID number</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC33" class="react-file-line html-div" data-testid="code-cell" data-line-number="33" style="position:relative">    </div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC34" class="react-file-line html-div" data-testid="code-cell" data-line-number="34" style="position:relative"><span class="pl-k">for</span> <span class="pl-s1">training_name</span> <span class="pl-c1">in</span> <span class="pl-s1">training_names</span>:</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC35" class="react-file-line html-div" data-testid="code-cell" data-line-number="35" style="position:relative">    <span class="pl-s1">dir</span> <span class="pl-c1">=</span> <span class="pl-s1">os</span>.<span class="pl-s1">path</span>.<span class="pl-en">join</span>(<span class="pl-s1">train_path</span>, <span class="pl-s1">training_name</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC36" class="react-file-line html-div" data-testid="code-cell" data-line-number="36" style="position:relative">    <span class="pl-s1">class_path</span> <span class="pl-c1">=</span> <span class="pl-en">imglist</span>(<span class="pl-s1">dir</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC37" class="react-file-line html-div" data-testid="code-cell" data-line-number="37" style="position:relative">    <span class="pl-s1">image_paths</span><span class="pl-c1">+=</span><span class="pl-s1">class_path</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC38" class="react-file-line html-div" data-testid="code-cell" data-line-number="38" style="position:relative">    <span class="pl-s1">image_classes</span><span class="pl-c1">+=</span>[<span class="pl-s1">class_id</span>]<span class="pl-c1">*</span><span class="pl-en">len</span>(<span class="pl-s1">class_path</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC39" class="react-file-line html-div" data-testid="code-cell" data-line-number="39" style="position:relative">    <span class="pl-s1">class_id</span><span class="pl-c1">+=</span><span class="pl-c1">1</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC40" class="react-file-line html-div" data-testid="code-cell" data-line-number="40" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC41" class="react-file-line html-div" data-testid="code-cell" data-line-number="41" style="position:relative"><span class="pl-c"># Create feature extraction and keypoint detector objects</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC42" class="react-file-line html-div" data-testid="code-cell" data-line-number="42" style="position:relative"><span class="pl-c">#SIFT is not available anymore in openCV (patented- need to get a license?)   </span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC43" class="react-file-line html-div" data-testid="code-cell" data-line-number="43" style="position:relative"><span class="pl-c"># Create List where all the descriptors will be stored</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC44" class="react-file-line html-div" data-testid="code-cell" data-line-number="44" style="position:relative"><span class="pl-s1">des_list</span> <span class="pl-c1">=</span> []</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC45" class="react-file-line html-div" data-testid="code-cell" data-line-number="45" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC46" class="react-file-line html-div" data-testid="code-cell" data-line-number="46" style="position:relative"><span class="pl-c">#BRISK is a good replacement to SIFT (patented - license needed). ORB also works - may need to try for this dataset.</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC47" class="react-file-line html-div" data-testid="code-cell" data-line-number="47" style="position:relative"><span class="pl-c">#brisk = cv2.BRISK_create(250) #try 250 and 500 features</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC48" class="react-file-line html-div" data-testid="code-cell" data-line-number="48" style="position:relative"><span class="pl-c">#orb = cv2.ORB_create(250) #try 250 and 500 features</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC49" class="react-file-line html-div" data-testid="code-cell" data-line-number="49" style="position:relative"><span class="pl-s1">sift</span> <span class="pl-c1">=</span> <span class="pl-s1">cv2</span>.<span class="pl-s1">xfeatures2d</span>.<span class="pl-v">SIFT_create</span>(<span class="pl-c1">500</span>) <span class="pl-c">#try 250 and 500 features</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC50" class="react-file-line html-div" data-testid="code-cell" data-line-number="50" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC51" class="react-file-line html-div" data-testid="code-cell" data-line-number="51" style="position:relative"><span class="pl-k">for</span> <span class="pl-s1">image_path</span> <span class="pl-c1">in</span> <span class="pl-s1">image_paths</span>:</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC52" class="react-file-line html-div" data-testid="code-cell" data-line-number="52" style="position:relative">    <span class="pl-s1">im</span> <span class="pl-c1">=</span> <span class="pl-s1">cv2</span>.<span class="pl-en">imread</span>(<span class="pl-s1">image_path</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC53" class="react-file-line html-div" data-testid="code-cell" data-line-number="53" style="position:relative">    <span class="pl-s1">kpts</span>, <span class="pl-s1">des</span> <span class="pl-c1">=</span> <span class="pl-s1">sift</span>.<span class="pl-en">detectAndCompute</span>(<span class="pl-s1">im</span>, <span class="pl-c1">None</span>) </div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC54" class="react-file-line html-div" data-testid="code-cell" data-line-number="54" style="position:relative">    <span class="pl-s1">des_list</span>.<span class="pl-en">append</span>((<span class="pl-s1">image_path</span>, <span class="pl-s1">des</span>))</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC55" class="react-file-line html-div" data-testid="code-cell" data-line-number="55" style="position:relative">    </div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC56" class="react-file-line html-div" data-testid="code-cell" data-line-number="56" style="position:relative"><span class="pl-c"># Stack all the descriptors vertically in a numpy array</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC57" class="react-file-line html-div" data-testid="code-cell" data-line-number="57" style="position:relative"><span class="pl-s1">descriptors</span> <span class="pl-c1">=</span> <span class="pl-s1">des_list</span>[<span class="pl-c1">0</span>][<span class="pl-c1">1</span>]</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC58" class="react-file-line html-div" data-testid="code-cell" data-line-number="58" style="position:relative"><span class="pl-k">for</span> <span class="pl-s1">image_path</span>, <span class="pl-s1">descriptor</span> <span class="pl-c1">in</span> <span class="pl-s1">des_list</span>[<span class="pl-c1">1</span>:]:</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC59" class="react-file-line html-div" data-testid="code-cell" data-line-number="59" style="position:relative">    <span class="pl-s1">descriptors</span> <span class="pl-c1">=</span> <span class="pl-s1">np</span>.<span class="pl-en">vstack</span>((<span class="pl-s1">descriptors</span>, <span class="pl-s1">descriptor</span>))  </div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC60" class="react-file-line html-div" data-testid="code-cell" data-line-number="60" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC61" class="react-file-line html-div" data-testid="code-cell" data-line-number="61" style="position:relative"><span class="pl-c">#kmeans works only on float, so convert integers to float</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC62" class="react-file-line html-div" data-testid="code-cell" data-line-number="62" style="position:relative"><span class="pl-s1">descriptors_float</span> <span class="pl-c1">=</span> <span class="pl-s1">descriptors</span>.<span class="pl-en">astype</span>(<span class="pl-s1">float</span>)  </div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC63" class="react-file-line html-div" data-testid="code-cell" data-line-number="63" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC64" class="react-file-line html-div" data-testid="code-cell" data-line-number="64" style="position:relative"><span class="pl-c"># Perform k-means clustering and vector quantization</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC65" class="react-file-line html-div" data-testid="code-cell" data-line-number="65" style="position:relative"><span class="pl-k">from</span> <span class="pl-s1">scipy</span>.<span class="pl-s1">cluster</span>.<span class="pl-s1">vq</span> <span class="pl-k">import</span> <span class="pl-s1">kmeans</span>, <span class="pl-s1">vq</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC66" class="react-file-line html-div" data-testid="code-cell" data-line-number="66" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC67" class="react-file-line html-div" data-testid="code-cell" data-line-number="67" style="position:relative"><span class="pl-s1">k</span> <span class="pl-c1">=</span> <span class="pl-c1">100</span>  <span class="pl-c">#try kmeans with 100, 200 and (maybe 300) clusters</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC68" class="react-file-line html-div" data-testid="code-cell" data-line-number="68" style="position:relative"><span class="pl-s1">voc</span>, <span class="pl-s1">variance</span> <span class="pl-c1">=</span> <span class="pl-en">kmeans</span>(<span class="pl-s1">descriptors_float</span>, <span class="pl-s1">k</span>, <span class="pl-c1">1</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC69" class="react-file-line html-div" data-testid="code-cell" data-line-number="69" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC70" class="react-file-line html-div" data-testid="code-cell" data-line-number="70" style="position:relative"><span class="pl-c"># Calculate the histogram of features and represent them as vector</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC71" class="react-file-line html-div" data-testid="code-cell" data-line-number="71" style="position:relative"><span class="pl-c">#vq Assigns codes from a code book to observations.</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC72" class="react-file-line html-div" data-testid="code-cell" data-line-number="72" style="position:relative"><span class="pl-s1">im_features</span> <span class="pl-c1">=</span> <span class="pl-s1">np</span>.<span class="pl-en">zeros</span>((<span class="pl-en">len</span>(<span class="pl-s1">image_paths</span>), <span class="pl-s1">k</span>), <span class="pl-s">&quot;float32&quot;</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC73" class="react-file-line html-div" data-testid="code-cell" data-line-number="73" style="position:relative"><span class="pl-k">for</span> <span class="pl-s1">i</span> <span class="pl-c1">in</span> <span class="pl-en">range</span>(<span class="pl-en">len</span>(<span class="pl-s1">image_paths</span>)):</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC74" class="react-file-line html-div" data-testid="code-cell" data-line-number="74" style="position:relative">    <span class="pl-s1">words</span>, <span class="pl-s1">distance</span> <span class="pl-c1">=</span> <span class="pl-en">vq</span>(<span class="pl-s1">des_list</span>[<span class="pl-s1">i</span>][<span class="pl-c1">1</span>],<span class="pl-s1">voc</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC75" class="react-file-line html-div" data-testid="code-cell" data-line-number="75" style="position:relative">    <span class="pl-k">for</span> <span class="pl-s1">w</span> <span class="pl-c1">in</span> <span class="pl-s1">words</span>:</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC76" class="react-file-line html-div" data-testid="code-cell" data-line-number="76" style="position:relative">        <span class="pl-s1">im_features</span>[<span class="pl-s1">i</span>][<span class="pl-s1">w</span>] <span class="pl-c1">+=</span> <span class="pl-c1">1</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC77" class="react-file-line html-div" data-testid="code-cell" data-line-number="77" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC78" class="react-file-line html-div" data-testid="code-cell" data-line-number="78" style="position:relative"><span class="pl-c"># Perform Tf-Idf vectorization</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC79" class="react-file-line html-div" data-testid="code-cell" data-line-number="79" style="position:relative"><span class="pl-s1">nbr_occurences</span> <span class="pl-c1">=</span> <span class="pl-s1">np</span>.<span class="pl-en">sum</span>((<span class="pl-s1">im_features</span> <span class="pl-c1">&gt;</span> <span class="pl-c1">0</span>) <span class="pl-c1">*</span> <span class="pl-c1">1</span>, <span class="pl-s1">axis</span> <span class="pl-c1">=</span> <span class="pl-c1">0</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC80" class="react-file-line html-div" data-testid="code-cell" data-line-number="80" style="position:relative"><span class="pl-s1">idf</span> <span class="pl-c1">=</span> <span class="pl-s1">np</span>.<span class="pl-en">array</span>(<span class="pl-s1">np</span>.<span class="pl-en">log</span>((<span class="pl-c1">1.0</span><span class="pl-c1">*</span><span class="pl-en">len</span>(<span class="pl-s1">image_paths</span>)<span class="pl-c1">+</span><span class="pl-c1">1</span>) <span class="pl-c1">/</span> (<span class="pl-c1">1.0</span><span class="pl-c1">*</span><span class="pl-s1">nbr_occurences</span> <span class="pl-c1">+</span> <span class="pl-c1">1</span>)), <span class="pl-s">&#039;float32&#039;</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC81" class="react-file-line html-div" data-testid="code-cell" data-line-number="81" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC82" class="react-file-line html-div" data-testid="code-cell" data-line-number="82" style="position:relative"><span class="pl-c"># Scaling the words</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC83" class="react-file-line html-div" data-testid="code-cell" data-line-number="83" style="position:relative"><span class="pl-c">#Standardize features by removing the mean and scaling to unit variance</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC84" class="react-file-line html-div" data-testid="code-cell" data-line-number="84" style="position:relative"><span class="pl-c">#In a way normalization</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC85" class="react-file-line html-div" data-testid="code-cell" data-line-number="85" style="position:relative"><span class="pl-k">from</span> <span class="pl-s1">sklearn</span>.<span class="pl-s1">preprocessing</span> <span class="pl-k">import</span> <span class="pl-v">StandardScaler</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC86" class="react-file-line html-div" data-testid="code-cell" data-line-number="86" style="position:relative"><span class="pl-s1">stdSlr</span> <span class="pl-c1">=</span> <span class="pl-v">StandardScaler</span>().<span class="pl-en">fit</span>(<span class="pl-s1">im_features</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC87" class="react-file-line html-div" data-testid="code-cell" data-line-number="87" style="position:relative"><span class="pl-s1">im_features</span> <span class="pl-c1">=</span> <span class="pl-s1">stdSlr</span>.<span class="pl-en">transform</span>(<span class="pl-s1">im_features</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC88" class="react-file-line html-div" data-testid="code-cell" data-line-number="88" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC89" class="react-file-line html-div" data-testid="code-cell" data-line-number="89" style="position:relative"><span class="pl-c">#Train an algorithm to discriminate vectors corresponding to positive and negative training images</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC90" class="react-file-line html-div" data-testid="code-cell" data-line-number="90" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC91" class="react-file-line html-div" data-testid="code-cell" data-line-number="91" style="position:relative"><span class="pl-c">#Train the Linear SVM</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC92" class="react-file-line html-div" data-testid="code-cell" data-line-number="92" style="position:relative"><span class="pl-c">#from sklearn.svm import LinearSVC</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC93" class="react-file-line html-div" data-testid="code-cell" data-line-number="93" style="position:relative"><span class="pl-c">#clf = LinearSVC(max_iter=10000)  #Default of 100 is not converging</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC94" class="react-file-line html-div" data-testid="code-cell" data-line-number="94" style="position:relative"><span class="pl-c">#clf.fit(im_features, np.array(image_classes))</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC95" class="react-file-line html-div" data-testid="code-cell" data-line-number="95" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC96" class="react-file-line html-div" data-testid="code-cell" data-line-number="96" style="position:relative"><span class="pl-c">#Train Random forest to compare how it does against SVM</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC97" class="react-file-line html-div" data-testid="code-cell" data-line-number="97" style="position:relative"><span class="pl-c">#from sklearn.ensemble import RandomForestClassifier</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC98" class="react-file-line html-div" data-testid="code-cell" data-line-number="98" style="position:relative"><span class="pl-c">#clf = RandomForestClassifier(n_estimators = 200, random_state=42) #try 100 and 200 estimators</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC99" class="react-file-line html-div" data-testid="code-cell" data-line-number="99" style="position:relative"><span class="pl-c">#clf.fit(im_features, np.array(image_classes))</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC100" class="react-file-line html-div" data-testid="code-cell" data-line-number="100" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC101" class="react-file-line html-div" data-testid="code-cell" data-line-number="101" style="position:relative"><span class="pl-c">#Train the xgboost to compare how it does against SVM and RF</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC102" class="react-file-line html-div" data-testid="code-cell" data-line-number="102" style="position:relative"><span class="pl-k">from</span> <span class="pl-s1">xgboost</span> <span class="pl-k">import</span> <span class="pl-v">XGBClassifier</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC103" class="react-file-line html-div" data-testid="code-cell" data-line-number="103" style="position:relative"><span class="pl-s1">clf</span> <span class="pl-c1">=</span> <span class="pl-v">XGBClassifier</span>(<span class="pl-s1">n_estimators</span> <span class="pl-c1">=</span> <span class="pl-c1">200</span>) <span class="pl-c">#try n_estimators = 200; the default is 100</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC104" class="react-file-line html-div" data-testid="code-cell" data-line-number="104" style="position:relative"><span class="pl-s1">clf</span>.<span class="pl-en">fit</span>(<span class="pl-s1">im_features</span>, <span class="pl-s1">np</span>.<span class="pl-en">array</span>(<span class="pl-s1">image_classes</span>))</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC105" class="react-file-line html-div" data-testid="code-cell" data-line-number="105" style="position:relative">
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC107" class="react-file-line html-div" data-testid="code-cell" data-line-number="107" style="position:relative"><span class="pl-c"># Save the SVM or RF, change pkl file name accordingly</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC108" class="react-file-line html-div" data-testid="code-cell" data-line-number="108" style="position:relative"><span class="pl-c">#Joblib dumps Python object into one file</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC109" class="react-file-line html-div" data-testid="code-cell" data-line-number="109" style="position:relative"><span class="pl-k">from</span> <span class="pl-s1">sklearn</span>.<span class="pl-s1">externals</span> <span class="pl-k">import</span> <span class="pl-s1">joblib</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC110" class="react-file-line html-div" data-testid="code-cell" data-line-number="110" style="position:relative"><span class="pl-s1">joblib</span>.<span class="pl-en">dump</span>((<span class="pl-s1">clf</span>, <span class="pl-s1">training_names</span>, <span class="pl-s1">stdSlr</span>, <span class="pl-s1">k</span>, <span class="pl-s1">voc</span>), <span class="pl-s">&quot;PE2_DA_bovw_sift500_km100_XGB200.pkl&quot;</span>, <span class="pl-s1">compress</span><span class="pl-c1">=</span><span class="pl-c1">3</span>)</div></div></div></div></div></div><div id="copilot-button-container"></div></div><div id="highlighted-line-menu-container"></div></div></div><button hidden="" data-testid="hotkey-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></section></div></div></div> <!-- --> <!-- --> </div></div></div><div class="Box-sc-g0xbh4-0"></div></div></div></div></div><div id="find-result-marks-container" class="Box-sc-g0xbh4-0 aZrVR"></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div> <!-- --> <!-- --> <!-- --> <script type="application/json" id="__PRIMER_DATA__">{"resolvedServerColorMode":"day"}</script></div>
</react-app>
</turbo-frame>
